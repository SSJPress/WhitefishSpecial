...
@CapabilityDescription("I MADE MY OWN GET HTTP PROCESSOR.  WITH STRIPPERS AND BLACKJACK")
@WritesAttributes({
...
public class BenderGetHTTPProcessor extends AbstractSessionFactoryProcessor {
...
//        }
        ...
        final SSLContextService sslContextService = null;
...
//            }
            ...
            try {
                ...
                flowFile = session.putAttribute(flowFile, CoreAttributes.FILENAME.key(), context.getProperty(FILENAME).evaluateAttributeExpressions(incomingFlowFile).getValue());
